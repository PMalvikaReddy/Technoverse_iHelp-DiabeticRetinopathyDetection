...
def mail(receiver_mail_id, message):
    ...
    s.starttls()
    s.login("ihelp.practice@gmail.com", "umlkctqunedbvvag")
    s.sendmail("ihelp.practice@gmail.com", receiver_mail_id, message)
    s.quit()
...
def predict_new(path, name, emailId, username, contact):
    ...
    G.G.
    '''
    sender = 'ihelp.practice@gmail.com'
    password = 'umlkctqunedbvvag'
    receiver = emailId
